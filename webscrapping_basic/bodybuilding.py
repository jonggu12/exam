...
url = f"https://www.bodybuilding.com/workout-plans/goal/build-muscle"
driver.get(url)

routines = driver.find_elements(By.CLASS_NAME, "plan__grid__container")


# for routine in routines:
#     name = routine.find_element(By.XPATH,"//*[@id='FAWP_PLAN_THUMBNAIL_0']/figcaption/div[1]/span").text
